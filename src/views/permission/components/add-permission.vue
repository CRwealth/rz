  ...
  >
    <el-form ref="perForm" label-width="120px" :model="formData" :rules="rules">
      ...
      <el-form-item label="权限描述" prop="description">
        <el-input v-model="formData.description" style="width:90%" placeholder="请输入权限描述" />
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, trigger: 'blur', message: '权限名称必填' }],
        code: [{ required: true, trigger: 'blur', message: '权限标识必填' }],
      },
    }
  },
  methods: {
