<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p
              class="lastChild"
            >早安，{{ userInfo.username }} | {{ userInfo.companyName }}-{{ userInfo.departmentName }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    <lizhi :show-dialog.sync="showDialog" />
  </div>
</template>

<script>
import { mapGetters } from 'vuex'
import workCalendar from './compoents/work-calendar.vue'
import radar from './compoents/radar.vue'
import lizhi from './compoents/lizhi.vue'
export default {
  name: 'Dashboard',
  components: {
    workCalendar,
